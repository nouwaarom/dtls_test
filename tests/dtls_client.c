...
#define MESSAGE "This is a message from the client to the server"
...
int main(int argc, char* argv[]) {
    ...
    ret = mbedtls_x509_crt_parse(&cacert, (const unsigned char*) test_certificate, strlen(test_certificate) + 1);
    if (ret < 0) {
